# Generated by Django 4.1.7 on 2023-02-25 13:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='book',
            name='readers',
            field=models.ManyToManyField(related_name='fav_books', through='store.UserBookRelation', to=settings.AUTH_USER_MODEL),
        ),
    ]
